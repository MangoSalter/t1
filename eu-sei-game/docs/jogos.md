...
| **"Ronda 3 de 5"**, na folha de respostas e no fim de cada ronda | Eu sei clássico, na sala | O número estava no documento da sala desde sempre e não aparecia em lado nenhum — só servia para escolher o texto de um botão no fim. Numa partida de cinco rondas não havia como saber se se estava na primeira ou na quarta; o Desenha e Adivinha já dizia "Ronda 1/3" |
| **Os últimos dez segundos avisam**: o relógio fica vermelho e a pulsar, e nos últimos três há um toque | As três fases cronometradas da sala e a folha do modo sozinho | O ecrã trocava a meio de uma palavra sem nada a dizer que vinha aí. É o que todos os jogos deste género fazem. O aviso é triplo porque um só não chega a toda a gente: a cor (medida, 5,8:1 — o vermelho da casa dava 4,0 e é texto, precisa de 4,5), o contorno, e o som para quem não está a olhar. Quem pede movimento reduzido perde o pulsar e fica com os outros dois |
| **Quem já vai onde**: durante a ronda, uma ficha por jogador com "Ana 3/5", e marcada a verde quem já acabou | Folha de respostas, na sala | Escrevia-se um minuto às escuras e depois alguém carregava em "Acabei!" e a ronda fechava em cima de toda a gente. É o que o StopotS mostra, e os números já estavam na sala — cada resposta é escrita à medida que se escreve. Só conta quem está ligado: um "Beto 0/5" parado é a informação errada para decidir se se carrega no botão |
| **O "Acabei!" dá cinco segundos a quem ainda está a escrever** — aviso com o nome de quem tocou e o relógio a contar a graça | Eu sei clássico, na sala | A outra metade do problema que a tira de progresso só mostrava: o toque de uma pessoa trocava o ecrã a toda a gente, a meio de uma palavra que já estava escrita menos a última letra. O STOP de mesa dá o mesmo ao dizer a palavra em voz alta; o StopotS conta uma contagem curta. Cinco segundos porque acabar uma palavra é isso, e mais do que isso já é uma ronda nova |
| **Quando quem desenha se vai embora, qualquer um segue em frente** — botão com o nome de quem saiu | Desenha e Adivinha / Onde Fica Isto?, na sala | Só quem desenha pode fechar a ronda (é o único que sabe a palavra) e este jogo não tem relógio. A regra que abria a exceção quando ele saía já existia no `room.js`; o ecrã escondia o botão a toda a gente menos ao próprio, ou seja, exatamente a quem já não estava lá. A sala ficava presa e a única saída era sair dela |
| **Trocar a palavra, uma vez por vez** — e o quadro limpa-se com ela | Desenha e Adivinha / Onde Fica Isto?, na sala | Calhar com uma palavra que não se sabe desenhar só tinha saída pelo "ninguém acertou", que fecha a ronda a toda a gente e não dá pontos a ninguém: perder a vez inteira por causa do sorteio. É a queixa de sempre do skribbl, que a resolve dando três palavras à escolha; uma troca chega e não obriga a inventar uma fase nova com o prazo que ela exigiria. O traço que já lá estava era da palavra velha, por isso sai — era uma pista de uma coisa que já não está em jogo. O botão fica à vista GASTO em vez de desaparecer: um controlo que some a meio da vez lê-se como avaria |
| **A lista do "🏆 Alguém acertou!" só tem quem está na sala** | Desenha e Adivinha / Onde Fica Isto?, na sala | Mostrava toda a gente que a sala alguma vez viu, e os pontos da ronda podiam ir para quem tinha fechado o telemóvel e não gritou nada. A ordem das vezes deste mesmo jogo já filtrava por ligado — era só a lista de vencedores que não |
| **Os controlos que nascem escondidos também se medem** — e o rascunho pessoal da Forca subiu para os 44px do costume | Todo o site (varrimento), Forca | Nenhum varrimento tinha tocado neles: um botão só escondido é invisível para quem mede. Eram cinco cores a 44x32, uma borracha a 40x44 e duas caixas a 44x25 — esta última porque a regra do telemóvel esconde o texto da etiqueta e deixa a caixa sozinha |
| **Cor, espessura e anular** para quem desenha | Desenha e Adivinha | O quadro ao lado tem 68 cores; aqui havia uma caneta só |
| **Copiar o resultado da noite** para colar numa conversa: sala, classificação e a frase da noite | Fim da partida | É assim que um jogo de festa chega a quem não esteve lá, e o desafio do dia já o fazia sozinho. O botão é de TODOS e não só do anfitrião — quem ficou em terceiro também quer mandar o print. Sem serviço nenhum pelo meio: é uma frase, e quem a manda decide a quem |
| **A frase da noite** no ecrã final: a resposta mais votada de "Engraçada", com o nome de quem a disse | Fim da partida clássica | O jogo que dá o nome à app não deixava nada de si no fim — o Desenha e Adivinha tem o álbum e o clássico tinha só uma tabela de pontos. Os votos de Engraçada já existiam e já valiam pontos, mas morriam com a ronda: o roundResults é apagado na seguinte. Guarda-se uma por partida, e o startGame apaga-a, porque é aí que uma partida começa |
...
| **A Forca de quem joga sozinho conta os erros na língua certa** ("Wrong letters", "Misses: 1 / 6") | Forca solo | Duas linhas que aparecem em todas as jogadas e estavam em português nas três línguas: são pintadas a meio do jogo, e o guarda das línguas entra pela Memória — nunca por aqui |
| **As 68 cores da paleta dizem-se na língua de quem joga** ("Red", "Rojo"), e o título do desafio do dia, o progresso do mapa e a maratona na tabela também | Paleta dos dois quadros; desafio do dia; mapa; recordes | A paleta abre-se dentro dos quadros e só se enche ao carregar no 🎨, por isso nenhuma varredura lhe tinha lido uma palavra. O título do desafio estava duas linhas acima de um resumo que já ia traduzido |
| **A quarta paleta também diz o nome das cores** (a do quadro de quem joga sozinho) e mais cinco frases que estavam em português duro: o "meteu em 12s" do Mini-Golfe, o "Quadro exportado", o "Arrisca quando quiseres" da Forca em sala | Quadro solo; Mini-Golfe; Forca em sala | A paleta lia "Cor #b24b38" em voz alta, e nenhum varrimento se podia queixar — é um nome acessível, só não diz nada a ninguém. As frases apareciam todas em estados que um teste não monta: quando alguém mete a bola, quando se exporta o quadro, quando se joga à Forca sem vez marcada |
...
| **O convite deixa de ser um endereço nu**: colado no WhatsApp mostra o nome, uma linha do que é, e a Dona Manga | A ligação do lobby, e o site todo | A ligação é o que faz entrar gente, e uma ligação sem antevisão não se abre — o Jackbox e o skribbl têm cartão. A imagem só é pedida pelo robô que faz a antevisão, nunca pelos telemóveis a jogar (medido: a primeira abertura continua nos 19 ficheiros). O caminho é relativo de propósito, porque o README diz que este repositório pode mudar de nome. A barra do browser passa também a ser bege em vez de cinzenta |
| **E o "Começar" do anfitrião recusa o segundo toque** | Sala de espera | O segundo toque — o que qualquer pessoa dá a um botão que não respondeu — voltava a chamar o startGame, que repõe a ronda a 1 e sorteia outra bola. Numa rede lenta isso chega depois de os outros já estarem a jogar e a partida recomeça para toda a gente |
| **Os botões de criar e entrar dizem que estão a trabalhar** e recusam o segundo toque | Ecrã de entrada | São os dois únicos gestos antes de haver jogo e ambos esperam pela rede — numa festa, em dez telemóveis ao mesmo tempo e muitas vezes nos dados de outra pessoa. Um botão calado durante três segundos lê-se como avariado e leva logo com outro toque. Medido no telemóvel: 342x50 antes e durante, sem encolher debaixo do dedo |
...
| **O que se cola numa conversa também fala a língua de quem joga**: o resultado do desafio do dia, o "Copiado", e o "(desligado)" na sala de espera | Desafio do dia; sala de espera | Três frases em português duro que nenhuma varredura podia ver, porque só existem em estados que um teste nunca monta: depois de carregar em copiar, e quando alguém fecha o telemóvel. A do desafio é a que mais longe viaja — vai para a conversa de outra pessoa |
...
| "Estar à espera da vez" — a queixa nº1 do skribbl | **Esta linha estava errada** e dizia que quem não desenha escreve palpites: não escreve nada. No Desenha e Adivinha adivinha-se **em voz alta** e quem desenha julga de ouvido; na Forca quem não tem a caneta vota letras, e isso sim é verdade | E é de propósito: este jogo é para gente na mesma sala, por isso quem não tem a caneta está a falar, não à espera. O skribbl tem a queixa porque os seus jogadores estão cada um em sua casa. Se algum dia houver salas à distância, é aqui que se sente primeiro — e a resposta será uma caixa de palpites, não mexer no resto |
...
| O álbum do Gartic Phone (ver no fim tudo o que se desenhou) | **Feito.** Os resultados finais mostram os desenhos da noite, com quem desenhou e quem acertou; toca-se num para o guardar. E **aguenta um F5**: fica no separador com o código da sala colado, por isso volta na mesma sala e nunca noutra | Vive no browser de cada um (cada cliente já recebeu os traços), por isso a sala não engorda com imagens. O que fica por fora é inerente: quem chega tarde só tem de onde chegou |
| "Problemas de servidor" — a queixa técnica que se repete nas críticas | **Feito em parte.** Quando a ligação deste telemóvel cai, aparece uma faixa a dizê-lo. O `onDisconnect` já avisava os OUTROS de que alguém tinha caído; a quem caía não se dizia nada, e um ecrã parado a meio de uma ronda não se distingue de "está tudo calado a escrever" | A faixa espera segundo e meio (a Firebase pisca por tudo e por nada), não apanha o toque e não tapa nenhum controlo por inteiro — as duas coisas medidas, porque no topo tapava a saída do mapa e do quadro, que prendia na app exatamente quem tem problemas de rede |
| **Voltar da rede não deixava de se ser fantasma** | Corrigido. O `connected: true` só era escrito ao criar, entrar e reentrar; quando a ligação caía e voltava, ninguém nos marcava presentes outra vez | Ficava-se fantasma para a sala até recarregar a página — e metade das regras contam por `connected`: quem pode começar, a ordem das vezes do desenho, o mínimo para os bónus, a infeção. O `onDisconnect` também se rearma, porque gasta-se quando dispara |
